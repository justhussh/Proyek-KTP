                ...
                ? Expanded(
                  child: Center(
                    child: FloatingActionButton(
                      ...
                      backgroundColor: Colors.black, // Mengatur latar belakang tombol menjadi hitam
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)), // Mengatur bentuk tombol menjadi bulat dengan radius 20
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
              ...
              child: Padding(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    primary: Colors.black, // Mengatur latar belakang tombol menjadi hitam
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(12), // Mengatur radius border menjadi 12
                    ),
                    padding: EdgeInsets.symmetric(horizontal: 150), // Mengatur padding horizontal
                  ),
                  child: Padding(
                    padding: EdgeInsets.symmetric(vertical: 10), // Mengatur padding vertikal
                    child: Text(
                      'Login',
                      style: TextStyle(
                        fontSize: 16,
